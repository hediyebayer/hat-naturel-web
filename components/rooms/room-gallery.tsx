    ...
    <>
      ...
      <div className="grid gap-5 md:grid-cols-[1fr_140px] lg:grid-cols-[1fr_160px]">
        ...
        <div
          ...
          className="group relative h-[220px] w-full overflow-hidden rounded-2xl bg-neutral-100 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.25)] sm:aspect-[4/3] sm:h-auto md:aspect-[16/10] md:rounded-3xl"
